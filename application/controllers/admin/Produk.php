...
class Produk extends Render_Controller
{
    ...
    {
        // data
        $this->data['judul'] = $this->key_get($this->key_produk_judul);
        $this->data['sub_judul'] = $this->key_get($this->key_produk_sub_judul);
        $this->data['show'] = $this->key_get($this->key_produk_show);
    ...
    public function update()
    {
        ...
        $judul = $this->key_set($this->key_produk_judul, $main, $show);

        // sub_judul
        $main = $this->input->post('main_sub_judul');
        $show = $this->input->post('show_sub_judul') == null ? 0 : 1;
        $sub_judul = $this->key_set($this->key_produk_sub_judul, $main, $show);

        // perlihatkan konten
        $show_content = $this->key_set($this->key_produk_show, $this->input->post('show_content') == null ? 0 : 1, null);
    ...
    function __construct()
    {
        ...
        $this->photo_path = './files/image/produk/';
