...
class TeamModel extends Render_Model
{
    ...
    public function insert($user_id, $nama, $foto, $status, $keterangan,  $jabatan)
    {
        $data = [
            'nama' => $nama,
            'jabatan' => $jabatan,
        ...
        // Insert users
        $execute = $this->db->insert('team', $data);
        $execute = $this->db->insert_id();
        return $execute;
    }

    public function update($id, $user_id, $nama, $foto, $status, $keterangan,  $jabatan)
    {
        $data = [
            'nama' => $nama,
            'jabatan' => $jabatan,
        ...
        $execute = $this->db->update('team', $data);
        return  $execute;
    }
    ...
    {
        // Delete users
        $exe = $this->db->where('id', $id)->delete('team');
        return $exe;
    }
