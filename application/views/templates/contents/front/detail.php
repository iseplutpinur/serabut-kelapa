          ...
          <div class="product-summery position-relative">
            ...
            <div class="quantity-with_btn mb-5">
              <div class="add-to_cart">
                <a class="btn product-cart button-icon flosun-button dark-btn" href="https://api.whatsapp.com/send?phone=<?= $whatsapp ?>&message=Hai kak. Saya tertarik dengan <?= $data->product->name; ?>">Pesan Sekarang</a>
              </div>
            </div>
          </div>
        </div>
