                ...
                <div class="single-item swiper-slide">
                  <div class="single-product position-relative mb-30">
                    ...
                    <div class="product-content">
                      ...
                      <a href="https://api.whatsapp.com/send?phone=<?= $whatsapp ?>&message=Hai kak. Saya tertarik dengan <?= $product1['name']; ?>" class="btn flosun-button secondary-btn theme-color rounded-0 mt-3">Pesan Sekarang</a>
                    </div>
                  </div>
                  <?php if ($product2 != null) : ?>
                    <div class="single-product position-relative mb-30">
                      ...
                      <div class="product-content">
                        ...
                        <a href="https://api.whatsapp.com/send?phone=<?= $whatsapp ?>&message=Hai kak. Saya tertarik dengan <?= $product2['name']; ?>" class="btn flosun-button secondary-btn theme-color rounded-0 mt-3">Pesan Sekarang</a>
                      </div>
                    </div>
                  <?php endif ?>
                </div>
