...
<head>
	...
	<title><?= $title ?> | <?= $pengaturan['title']['value2'] ?></title>
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="<?= base_url() ?>" class="brand-link">
				<img src="<?= base_url('files/image/pengaturan/' . $pengaturan['icon']['value1']) ?>" alt="><?= $pengaturan['title']['value2'] ?>" class="brand-image img-circle elevation-3" style="opacity: .8">
				<span class="brand-text font-weight-light"><?= $pengaturan['title']['value2'] ?></span>
			</a>
		...
		<!-- Main Footer -->
		<footer class="main-footer" id="coyright">
			<!-- To the right -->
